			...
			<section className='privacy-policy'>
				<div className='privacy-policy-container'>
					...
					<div className='privacy-policy-box'>
						...
						<p>
							Podejmuję wszelkie środki techniczne i organizacyjne, aby zapewnić bezpieczeństwo Twoich danych osobowych,
							w tym zabezpieczenie przed dostępem osób nieuprawnionych oraz przed nieautoryzowaną zmianą, ujawnieniem
					...
					<div className='privacy-policy-box'>
						...
						<p style={{ paddingTop: '1em' }}>
							Google reCAPTCHA zbiera i przetwarza dane, takie jak adres IP, dane dotyczące urządzenia, a także sposób,
							w jaki użytkownik korzysta z mojej strony internetowej. Informacje te są wykorzystywane przez Google do
